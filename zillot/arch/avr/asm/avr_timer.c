...
static uint8_t avr_timer_no(uintptr_t regs)
{
	...
	{
	case (uintptr_t)&TCCR0A: return 0;
	case (uintptr_t)&TCCR1A: return 1;
	case (uintptr_t)&TCCR2A: return 2;
#ifdef TCCR3A
	case (uintptr_t)&TCCR3A: return 3;
#endif
#ifdef TCCR4A
	case (uintptr_t)&TCCR4A: return 4;
#endif
	default: BUG();
	}
}
